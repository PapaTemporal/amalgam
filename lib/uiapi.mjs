...
export function buildApi() {
  return {
    ...
    "POST /api/setup/machine": ({ body }) => {
      ...
      return { jobId: startJob(steps, { cwd: PKG }).id };
    },
    ...
    "POST /api/setup/project": ({ body }) => {
      ...
      return { jobId: startJob(steps, { cwd: dir }).id, project: projectSummary(dir) };
    },
    ...
    "POST /api/run": ({ body }) => {
      ...
      return { jobId: startJob([{ label: body.what, command }], { cwd: dir }).id };
    },
  };
}
